...
<div id="nav" class="container">
    ...
    <div id="test2" class="col s3"><p>Test 2</p></div>
    <div id="test3" class="col s3"><p>Test 3</p></div>
    <div id="test4" class="col s3"><p>Test 4</p></div>
    <div id="test0" class="col s3"><p>Test 5</p></div>
</div>
